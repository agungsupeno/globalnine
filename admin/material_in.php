...
include 'Search/js_material_in.php';
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Form Material Masuk</h5>
              </div>
              <div class="card-body">
              <form method="post">
                <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <button type="submit" class="btn btn-primary" name="addmaterialin">
          ...
          <div class="col-lg-8">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Data Material Masuk</h5>
                <div class="card-tools">
                  <form action="material_in.php" method="get">
              ...
              <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($ambildata)) {
                        ...
                        <tr>
                            ...
                            <?php include 'Editdata/edit_material_in.php'; ?>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <table>
                  <thead>
                    <tr>
                      <td>
                        <button class="btn btn-success btn-sm" onclick="cetakData()">
                        ...
                        function cetakData() {
                            ...
                            var printUrl = 'pdf/material_in_pdf.php?start_date=' + startDate + '&end_date=' + endDate;
...
<?php
    ...
    include 'Web/material_in.php';
    include 'Search/s_material_in.php';
?>
